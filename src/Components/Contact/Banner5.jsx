    ...
    <div>
        <div className='py-[60px] px-[80px]'>
            <div className='px-[32px] gap-10 flex flex-col items-center justify-center'>
                ...
                <p className='font-normal text-zinc-500 text-base md:w-[500px] xsm:w-[300px] text-center'>I'm Aftab Ahmed Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to specimen book.</p>  
