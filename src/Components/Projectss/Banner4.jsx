    ...
    <div className='bg-black'>
        <div className='py-[60px] md:px-[80px]'>
            <div className='px-[32px]'>
                <div className={`flex md:flex-row xsm:flex-col justify-center items-center pt-2 ${isrotate && 'md:flex-row-reverse'}`}>
                    <div className='md:w-1/2 xsm:m-auto'>
                        <a href={hostLink} target='_blank'><img className='md:h-[350px] md:w-[530px] xsm:w-[343px] xsm:h-[300px] rounded' src={imgUrl} alt="" /></a>
                    </div>
