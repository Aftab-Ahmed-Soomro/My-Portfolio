    ...
    <div className='bg-black'>
        <div className='py-[60px] px-[80px]'>
            <div className='px-[32px]'>
                <div className={`flex md:flex-row xsm:flex-col  pt-10 ${isrotate && 'md:flex-row-reverse'}`}>
                    <div className='md:w-1/2 xsm:w-[343px] xsm:h-[397.73px] xsm:m-auto'>
                        <a href={hostLink} target='_blank'><img className='h-[350px] rounded' src={imgUrl} alt="" /></a>
                    </div>
